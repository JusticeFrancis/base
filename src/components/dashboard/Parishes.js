...
const Parishes = () => {
  ...
  return (
    <div className="grid grid-cols-9  lg:px-0 px-4 py-4">
        ...
        <div className="pt-7 px-4">
          ...
          <div className=" max-w-[100vw] lg:max-w-full overflow-auto  ">
            <div className="w-[800px] lg:max-w-full ">
              <div className="grid grid-cols-7 gap-2 text-[14px] ">
              ...
              <div className="grid grid-cols-7 gap-4 text-[15px] mt-4 bg-white  shadow-sm hover:shadow-lg cursor-pointer rounded-lg py-4  px-2 ">
                <div className="col-span-3 text-black">Malibu Parish 2</div>

                <div className="col-span-3 text-black">Province 1</div>
      ...
      <div className="lg:col-span-4 col-span-9 bg-white w-full lg:order-2 order-1   py-3">
        ...
        <AddDepartment open={openAddDepartmentModal} setOpen={setOpenDepartmentModal} loader={loader} setLoader={setLoader}/>

        <div className="px-7">
          <div className="flex items-center justify-between">
          <div className="text-[15px] font-semibold mb-2">Departments</div>
          <div> <AddCircle sx={{ color:'green', cursor:'pointer'}}
          onClick={()=> {
          ...
          <div className="text-[13px] mb-4">
            <div className="font-semibold flex items-center justify-between"> 
                ...
                <div className="flex items-center space-x-3">
                    <div className="text-red-900 font-normal hover:underline cursor-pointer">Remove</div>
                    <div className="text-blue-900 font-normal hover:underline cursor-pointer">Edit</div>
                </div>
            </div>
            <div>Mr John (team lead)</div>
            <div>
                The department for every member between ages 20 - 45
            </div>
            <div>
               meeting : Every Saturday 4pm @ church premises
            </div>
