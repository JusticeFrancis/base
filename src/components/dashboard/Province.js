...
const Province = () => {
  ...
  return (
    <div className="grid grid-cols-9  lg:px-0 py-4 px-4">
        <AddProvince open={open} setOpen={setOpen} loader={loader} setLoader={setLoader} />
          ...
          <div className=" max-w-[100vw] lg:max-w-full overflow-auto  ">
            <div className="w-[800px] lg:max-w-full ">
              <div className="grid grid-cols-10 gap-2 text-[14px] ">
                ...
                <div className="col-span-2 text-gray-500 ">Phone Number</div>
              ...
              <div className="grid grid-cols-10 gap-4 text-[15px] mt-4 bg-white  shadow-sm hover:shadow-lg cursor-pointer rounded-lg py-4  px-2 ">
                <div className="col-span-3 text-black">Malibu Province 2</div>

                <div className="col-span-3 text-black">
                  maliburccg@gmail.com
                </div>

                <div className="col-span-2 text-black">+124242323223</div>
